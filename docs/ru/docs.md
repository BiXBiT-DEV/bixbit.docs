...
**Как создаём.** На нужном уровне дерева (коллекция локали или уже открытая папка) нажмите **Add an entry**, заполните **Filename**, **Заголовок**, **Содержимое** → **Save**. Папку **не** создаём.
