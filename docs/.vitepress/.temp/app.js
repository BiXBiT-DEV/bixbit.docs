...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"VitePress","description":"A VitePress site","base":"/bixbit.docs/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":{"light":"/images/logo.svg","dark":"/images/logo-dark.svg","alt":"AMS Docs"},"search":{"provider":"local","options":{"locales":{"root":{"translations":{"button":{"buttonText":"Search","buttonAriaLabel":"Search documentation"},"modal":{"noResultsText":"No results found","resetButtonTitle":"Reset search","backButtonTitle":"Back","displayDetails":"Display detailed list","footer":{"selectText":"to select","selectKeyAriaLabel":"enter","navigateText":"to navigate","navigateUpKeyAriaLabel":"up arrow","navigateDownKeyAriaLabel":"down arrow","closeText":"to close","closeKeyAriaLabel":"escape"}}}},"ru":{"translations":{"button":{"buttonText":"Поиск","buttonAriaLabel":"Поиск по документации"},"modal":{"noResultsText":"Ничего не найдено","resetButtonTitle":"Сбросить","backButtonTitle":"Назад","displayDetails":"Показать подробности","footer":{"selectText":"перейти","selectKeyAriaLabel":"Enter","navigateText":"навигация","navigateUpKeyAriaLabel":"Стрелка вверх","navigateDownKeyAriaLabel":"Стрелка вниз","closeText":"закрыть","closeKeyAriaLabel":"Escape"}}}}}}},"sidebar":{"/":{"base":"/","items":[{"text":"Authors","link":"authors/index.md","items":[{"text":"Author 1","link":"authors/author-1/index.md"}],"collapsed":true},{"text":"Posts","link":"posts/index.md","items":[{"text":"Hello World","link":"posts/hello-world/index.md"}],"collapsed":true}]},"/ru/":{"base":"/ru/","items":[{"text":"Авторы","link":"authors/index.md","items":[{"text":"Автор 1","link":"authors/author-1/index.md"}],"collapsed":true},{"text":"Публикации","link":"posts/index.md","items":[{"text":"Привет, мир","link":"posts/hello-world/index.md"}],"collapsed":true}]}}},"locales":{"root":{"label":"English","lang":"en-US","title":"Documentation","description":"Documentation","themeConfig":{"nav":[],"outline":{"label":"On this page"},"docFooter":{"prev":"Previous","next":"Next"},"sidebarMenuLabel":"Menu","returnToTopLabel":"Return to top","darkModeSwitchLabel":"Appearance","lightModeSwitchTitle":"Switch to light theme","darkModeSwitchTitle":"Switch to dark theme","langMenuLabel":"Change language","skipToContentLabel":"Skip to content"}},"ru":{"label":"Русский","lang":"ru-RU","link":"/ru/","title":"Документация","description":"Документация","themeConfig":{"nav":[],"outline":{"label":"На этой странице"},"docFooter":{"prev":"Назад","next":"Далее"},"sidebarMenuLabel":"Меню","returnToTopLabel":"Наверх","darkModeSwitchLabel":"Тема оформления","lightModeSwitchTitle":"Светлая тема","darkModeSwitchTitle":"Тёмная тема","langMenuLabel":"Язык","skipToContentLabel":"Перейти к содержимому"}}},"scrollOffset":134,"cleanUrls":false,"additionalConfig":{}}'));
...
const _sfc_main$v = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.CwCTHy2A.js"));
