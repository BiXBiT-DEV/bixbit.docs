...
import { C as ChevronLeftIcon } from "./HomeOutlineIcon.CNMiJIJe.js";
...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"VitePress","description":"A VitePress site","base":"/bixbit.docs/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":{"light":"/images/logo.svg","dark":"/images/logo-dark.svg","alt":"AMS Docs"},"search":{"provider":"local","options":{"locales":{"root":{"translations":{"button":{"buttonText":"Поиск","buttonAriaLabel":"Поиск по документации"},"modal":{"noResultsText":"Ничего не найдено","resetButtonTitle":"Сбросить","backButtonTitle":"Назад","displayDetails":"Показать подробности","footer":{"selectText":"перейти","selectKeyAriaLabel":"Enter","navigateText":"навигация","navigateUpKeyAriaLabel":"Стрелка вверх","navigateDownKeyAriaLabel":"Стрелка вниз","closeText":"закрыть","closeKeyAriaLabel":"Escape"}}}},"en":{"translations":{"button":{"buttonText":"Search","buttonAriaLabel":"Search documentation"},"modal":{"noResultsText":"No results found","resetButtonTitle":"Reset search","backButtonTitle":"Back","displayDetails":"Display detailed list","footer":{"selectText":"to select","selectKeyAriaLabel":"enter","navigateText":"to navigate","navigateUpKeyAriaLabel":"up arrow","navigateDownKeyAriaLabel":"down arrow","closeText":"to close","closeKeyAriaLabel":"escape"}}}}}}},"sidebar":{"/":{"base":"/","items":[{"text":"Прошивка Antminer","link":"antminer-firmware/index.md"},{"text":"Автоматизация","link":"automated/index.md"},{"text":"Я","link":"new-section/index.md"},{"text":"UI Kit","link":"ui-kit"},{"text":"Руководство по Whatsminer ASIC","link":"user-guide-whatsminer-asic/index.md"},{"text":"Прошивка Whatsminer","link":"whatsminer-firmware/index.md","items":[{"text":"Подключение устройства","link":"whatsminer-firmware/connecting-a-device"},{"text":"Первоначальная настройка устройства","link":"whatsminer-firmware/initial-device-setup/index.md","items":[{"text":"Настройка отображения данных","link":"whatsminer-firmware/initial-device-setup/data-display-setup"},{"text":"Поиск майнера в сети","link":"whatsminer-firmware/initial-device-setup/network-identification"}],"collapsed":true},{"text":"Технические требования","link":"whatsminer-firmware/technical-requirements"}],"collapsed":true}]},"/en/":{"base":"/en/","items":[{"text":"Antminer Firmware","link":"antminer-firmware/index.md"},{"text":"Automated","link":"automated/index.md"},{"text":" I","link":"new-section/index.md"},{"text":"UI Kit","link":"ui-kit"},{"text":"User guide for Whatsminer ASIC","link":"user-guide-whatsminer-asic/index.md"},{"text":"Whatsminer Firmware","link":"whatsminer-firmware/index.md","items":[{"text":"Connecting a device","link":"whatsminer-firmware/connecting-a-device"},{"text":"Initial device setup","link":"whatsminer-firmware/initial-device-setup/index.md","items":[{"text":"Data display setup","link":"whatsminer-firmware/initial-device-setup/data-display-setup"},{"text":"Miner identification on the network","link":"whatsminer-firmware/initial-device-setup/network-identification"}],"collapsed":true},{"text":"Technical requirements","link":"whatsminer-firmware/technical-requirements"}],"collapsed":true}]}}},"locales":{"root":{"label":"Русский","lang":"ru-RU","title":"Документация","description":"Документация","themeConfig":{"nav":[],"outline":{"label":"На этой странице"},"docFooter":{"prev":"Назад","next":"Далее"},"sidebarMenuLabel":"Меню","returnToTopLabel":"Наверх","darkModeSwitchLabel":"Тема оформления","lightModeSwitchTitle":"Светлая тема","darkModeSwitchTitle":"Тёмная тема","langMenuLabel":"Язык","skipToContentLabel":"Перейти к содержимому"}},"en":{"label":"English","lang":"en-US","link":"/en/","title":"Documentation","description":"Documentation","themeConfig":{"nav":[],"outline":{"label":"On this page"},"docFooter":{"prev":"Previous","next":"Next"},"sidebarMenuLabel":"Menu","returnToTopLabel":"Return to top","darkModeSwitchLabel":"Appearance","lightModeSwitchTitle":"Switch to light theme","darkModeSwitchTitle":"Switch to dark theme","langMenuLabel":"Change language","skipToContentLabel":"Skip to content"}}},"scrollOffset":134,"cleanUrls":false,"additionalConfig":{}}'));
...
const VPHero = /* @__PURE__ */ _export_sfc(_sfc_main$X, [["__scopeId", "data-v-e62e4946"]]);
...
const VPFeature = /* @__PURE__ */ _export_sfc(_sfc_main$V, [["__scopeId", "data-v-e5511d04"]]);
...
const VPHome = /* @__PURE__ */ _export_sfc(_sfc_main$R, [["__scopeId", "data-v-bb6342a6"]]);
const _sfc_main$Q = {};
...
const VPContent = /* @__PURE__ */ _export_sfc(_sfc_main$P, [["__scopeId", "data-v-9dc86fcc"]]);
...
const VPMenuLink = /* @__PURE__ */ _export_sfc(_sfc_main$I, [["__scopeId", "data-v-867c295f"]]);
...
const VPNavBarExtra = /* @__PURE__ */ _export_sfc(_sfc_main$C, [["__scopeId", "data-v-562c832a"]]);
...
const VPNavBarMenuLink = /* @__PURE__ */ _export_sfc(_sfc_main$A, [["__scopeId", "data-v-6dd25bb8"]]);
const _sfc_main$z = /* @__PURE__ */ defineComponent({
...
const _sfc_main$v = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.CeR6Akpx.js"));
...
const VPNavBarTranslations = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["__scopeId", "data-v-fafa8c23"]]);
const _sfc_main$r = /* @__PURE__ */ defineComponent({
  __name: "VPNavBar",
  __ssrInlineRender: true,
  props: {
...
const Layout = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-0cf61682"]]);
const GridSettings = {
  xmini: [[0, 2]],
  mini: [],
  small: [
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  __name: "BackButtonDesktop",
  __ssrInlineRender: true,
  props: {
    label: { default: "Go to BiXBiT" }
  },
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<button${ssrRenderAttrs(mergeProps({
        ...
        type: "button"
      }, _attrs))} data-v-1faa5677><span class="back-button-desktop__icon" data-v-1faa5677>`);
      ssrRenderSlot(_ctx.$slots, "icon", {}, () => {
        _push(ssrRenderComponent(unref(ChevronLeftIcon), { class: "back-button-desktop__icon" }, null, _parent));
      }, _push, _parent);
      _push(`</span><span class="back-button-desktop__label" data-v-1faa5677>${ssrInterpolate(__props.label)}</span></button>`);
    };
  }
});
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/components/ui/BackButtonDesktop.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const BackButtonDesktop = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-1faa5677"]]);
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  __name: "AppSidebarTop",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "app-sidebar-top" }, _attrs))} data-v-aa681537>`);
      _push(ssrRenderComponent(BackButtonDesktop, null, null, _parent));
      _push(`</div>`);
    };
  }
});
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/components/app/AppSidebarTop.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const AppSidebarTop = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-aa681537"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "Layout",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(theme).Layout, _attrs, {
        "sidebar-nav-before": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(AppSidebarTop, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(AppSidebarTop)
            ];
          }
        }),
        _: 1
